...
exports.getUserLanguage = exports.translateMessage = exports.selectLanguage = exports.languageOptions = exports.userLanguageMap = void 0;
exports.translateToUzbek = translateToUzbek;
exports.translateToRussian = translateToRussian;
exports.translateToEnglish = translateToEnglish;
const mainMenu_1 = require("./mainMenu");
exports.userLanguageMap = new Map();
function translateToUzbek(text, variables = {}) {
    const translations = {
...
;
function translateToRussian(text, variables = {}) {
    const translations = {
...
;
function translateToEnglish(text, variables = {}) {
    const translations = {
...
const selectLanguage = async (chatId, bot) => {
    const options = exports.languageOptions.map(lang => ({ text: `${lang.flag} ${lang.name}`, callback_data: `start_lang_${lang.code}` }));
    ...
    (0, mainMenu_1.addMessageToContext)(chatId, message.message_id);
};
exports.selectLanguage = selectLanguage;
const translateMessage = (chatId, text, variables = {}) => {
    const userLanguage = exports.userLanguageMap.get(chatId);
    if (userLanguage) {
...
const getUserLanguage = (chatId) => {
    return exports.userLanguageMap.get(chatId)?.code || 'en';
};
exports.getUserLanguage = getUserLanguage;
//# sourceMappingURL=systemLangs.js.map